...
class PasswordReset3Screen extends StatefulWidget {
  static String id = Routes.password_reset_3;
  final String title;

  const PasswordReset3Screen({Key? key, required this.title}) : super(key: key);

  @override
  State<PasswordReset3Screen> createState() => _PasswordReset3ScreenState();
}

class _PasswordReset3ScreenState extends State<PasswordReset3Screen> {
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Align(
                                  alignment: Alignment.center,
                                  child: Text(
                                    "Votre mot de passe a été réinitialisé avec succès".tr,
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.bold,
                                    ),
