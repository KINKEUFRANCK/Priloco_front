...
class RegistrationVerify1Screen extends StatefulWidget {
  static String id = Routes.registration_verify_1;
  final String title;

  const RegistrationVerify1Screen({Key? key, required this.title}) : super(key: key);

  @override
  State<RegistrationVerify1Screen> createState() => _RegistrationVerify1ScreenState();
}

class _RegistrationVerify1ScreenState extends State<RegistrationVerify1Screen> {
                          ...
                          children: <Widget>[
                            ...
                            Center(
                              child: Container(
                                width: 260,
                                child: Text(
                                  "Entrez l'e-mail associé avec votre compte et nous vous enverrons un e-mail avec un code de confirmation de votre compte".tr,
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontWeight: FontWeight.bold,
                                  ),
                                    ...
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate()) {
                                        if (!_isSubmit) {
                                          ...
                                          try {
                                            http.Response response = await verifyRegistrationUser(emailController.text);
                                            switch (response.statusCode) {
                                              case 200:
                                                ...
                                                Flushbar(
                                                  ...
                                                  message: 'Un e-mail avec un code de confirmation de votre compte a été envoyé',
                                                )..show(context);
                                              ...
                                              default:
                                                Flushbar(
                                                  ...
                                                  flushbarPosition: FlushbarPosition.TOP,
                                                  title: 'Confirmation de votre compte ?'.tr,
                                                  message: "Une erreur a été rencontrée lors de la confirmation de votre compte",
                                                )..show(context);
                                                break;
                                            }
