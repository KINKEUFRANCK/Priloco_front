...
class PostCreateStep2Screen extends StatefulWidget {
  static String id = Routes.post_create_step_2;
  final String title;

  const PostCreateStep2Screen({Key? key, required this.title}) : super(key: key);

  @override
  State<PostCreateStep2Screen> createState() => _PostCreateStep2ScreenState();
}

class _PostCreateStep2ScreenState extends State<PostCreateStep2Screen> {
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate()) {
                                        postController.post = {...postController.post, 'title': titleController.text, 'price': priceController.text, 'promotion': promotionController.text, 'content': contentController.text,};
                                        Get.toNamed(Routes.post_create_step_3);
                                      } else {
                                        Flushbar(
                                          icon: Icon(
                                            Icons.info_outline,
