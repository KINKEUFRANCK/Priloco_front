...
class PostCreateStep3Screen extends StatefulWidget {
  static String id = Routes.post_create_step_3;
  final String title;

  const PostCreateStep3Screen({Key? key, required this.title}) : super(key: key);

  @override
  State<PostCreateStep3Screen> createState() => _PostCreateStep3ScreenState();
}

class _PostCreateStep3ScreenState extends State<PostCreateStep3Screen> {
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate()) {
                                        postController.post = {...postController.post, 'phone': phoneController.text, 'service': serviceController.text, 'condition': conditionController.text, 'url': urlController.text,};
                                        Get.toNamed(Routes.post_create_step_4);
                                      } else {
                                        Flushbar(
                                          icon: Icon(
                                            Icons.info_outline,
